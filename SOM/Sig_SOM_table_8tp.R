...
sig_snps <- subset(Full, p.week >= 3.8)
...
Sig_Traj_table_uni_dir_ds8 <- data.frame(matrix(ncol = 1, nrow = 8))
...
for (i in 1:nrow(maf)){
  ...
  Sig_Traj_table_uni_dir_ds8 <- cbind(Sig_Traj_table_uni_dir_ds8, maf_final)
  
  print(i)
}

Sig_Traj_table_uni_dir_ds8 <- Sig_Traj_table_uni_dir_ds8[,2:ncol(Sig_Traj_table_uni_dir_ds8)]



Trans_traj_sig_uni_dir_ds8 <- t(Sig_Traj_table_uni_dir_ds8)
save(Trans_traj_sig_uni_dir_ds8 , file="SOM_table_sig_8tp.rda")
