...
sig_snps <-  Full[sample(1:nrow(Full), size = 1096),]
...
Rand_Traj_table_uni_dir_ds13 <- data.frame(matrix(ncol = 1, nrow = 13))
...
for (i in 1:nrow(maf)){
  ...
  Rand_Traj_table_uni_dir_ds13 <- cbind(Rand_Traj_table_uni_dir_ds13, maf_final)
  
  print(i)
}

Rand_Traj_table_uni_dir_ds13 <- Rand_Traj_table_uni_dir_ds13[,2:ncol(Rand_Traj_table_uni_dir_ds13)]



Trans_traj_rand_uni_dir_ds13 <- t(Rand_Traj_table_uni_dir_ds13)
save(Trans_traj_rand_uni_dir_ds13 , file="SOM_table_random_13tp.rda")
