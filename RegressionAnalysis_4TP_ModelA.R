...
#Filter out "bad" populations (1,2,4,5 and 6) and downsample to 4 timepoints
...
write.table(p_table,"Pval_table_4tp_ModelA.txt", quote= FALSE, row.names= FALSE,col.names= TRUE, sep="\t")
